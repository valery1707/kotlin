...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(UNEXPECTED_TRAILING_LAMBDA_ON_A_NEW_LINE, "Expression is treated as an unexpected trailing lambda argument. Consider separating it from call with semicolon");
